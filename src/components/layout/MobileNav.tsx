/**
 * MOBILE NAV — Sheet-based sidebar for mobile
 * Fixed at root level to avoid containing block issues
 */

import { Link, useLocation } from 'react-router-dom';
import { X, Diamond, Home, Trophy, Gift, Dices, TrendingUp, CircleDot, Bomb, Disc, Spade, Ticket, Gamepad2, Sparkles } from 'lucide-react';
...
export default function MobileNav({ isOpen, onClose }: MobileNavProps) {
    ...
    return (
        <>
            ...
            <div
                className={cn(
                    "fixed top-0 left-0 h-full w-[280px] bg-[hsl(220,20%,8%)] border-r border-white/5 z-50 transform transition-transform duration-300 lg:hidden overflow-y-auto",
